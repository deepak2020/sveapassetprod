...
const LEVELS = [
  ...
  },
  {
    ...
    memoryTips: [
      {
        icon: Ear,
        title: "Lyssna två gånger",
        title_en: "Listen twice",
        body: "Innan du säger något — lyssna på Svea två gånger.",
        body_en: "Before you say anything — listen to Svea twice.",
      },
      {
        icon: Mic,
        title: "Prata långsamt",
        title_en: "Speak slowly",
        body: "Snabbt är inte bättre. Säg varje ord tydligt.",
        body_en: "Faster isn't better. Say each word clearly.",
      },
      {
        icon: Music,
        title: "Följ melodin",
        title_en: "Follow the melody",
        body: "Svenska går upp och ner. Härma tonen, inte bara orden.",
        body_en: "Swedish goes up and down. Copy the tune, not just the words.",
      },
      {
        icon: Repeat,
        title: "Säg det högt",
        title_en: "Say it out loud",
        body: "Viska inte. Din mun behöver träna rörelserna.",
        body_en: "Don't whisper. Your mouth needs to practice the movements.",
      },
    ],
