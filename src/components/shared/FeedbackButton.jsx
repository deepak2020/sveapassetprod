        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-16 left-0 right-0 md:bottom-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-md w-full z-50 bg-card rounded-t-2xl md:rounded-2xl border border-border/50 shadow-2xl max-h-[calc(100vh-5rem)] md:max-h-[90vh] overflow-y-auto"
            >
              {submitted ? (
