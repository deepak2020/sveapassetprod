    ...
    topics: [
      {
        ...
        exercises: [
          { q: "'___ hund springer i parken.'\nFill in the correct article.", options: ["en", "ett"], correct: 0, explanation: "Hund (dog) is an en-word — living creatures are almost always en-words." },
          { q: "Barn (child) — is it en or ett?", options: ["en barn", "ett barn"], correct: 1, explanation: "Barn is one of the most common ett-words — memorise it!" },
          { q: "Complete the sentence:\n'___ hus är stort.'", options: ["en", "ett"], correct: 1, explanation: "Hus (house) is an ett-word. Many short everyday objects are ett." },
          { q: "What is the gender of 'dag' (day)?", options: ["en-word", "ett-word"], correct: 0, explanation: "Dag is an en-word. Time words (dag, vecka, månad) are usually en." },
          { q: "Spot the mistake:\n'en äpple är rött'", options: ["No mistake", "Should be 'ett äpple'"], correct: 1, explanation: "Äpple (apple) is an ett-word: ett äpple är rött." },
          { q: "Pick the correct form:\n'___ stol står vid bordet.'", options: ["en stol", "ett stol"], correct: 0, explanation: "Stol (chair) is an en-word. Most furniture except bord/fönster/tak are en." },
          { q: "Bord (table) — en or ett?", options: ["en bord", "ett bord"], correct: 1, explanation: "Bord is an ett-word — one of the exceptions among furniture words." },
          { q: "Translate 'a car' into Swedish:", options: ["en bil", "ett bil"], correct: 0, explanation: "Bil (car) is an en-word. Vehicles are nearly always en." },
        ],
      },
      {
        id: "definite-forms",
...

  {
    ...
    topics: [
      ...
      },
      {
        ...
        title: "Subordinate Clauses (Bisatser)",
        titleSv: "Bisatser",
        description: "Types of bisatser, conjunctions (att, om, när, eftersom…), and BIFF-regeln word order.",
        rule: "Bisatser (subordinate clauses) cannot stand alone — they start with a subjunction and are embedded in a main clause. Common subjunctions: att (that), om (if/whether), när (when), medan (while), eftersom (because), fastän/fast (although), så att (so that), för att (in order to), innan (before), efter att (after), till (until), då (when/then). KEY RULE — BIFF-regeln: inside a bisats, sentence adverbs (inte, aldrig, redan, alltid, ofta, ju, nog) go BEFORE the finite verb — the opposite of main clauses. Pattern: subjunction + subject + (sentence adverb) + verb + rest. Example: 'Jag äter inte' (main) → '...att jag inte äter' (bisats).",
        learn: {
          concept: "A bisats (subordinate clause) is a clause that can't stand on its own — it depends on a main clause. It always starts with a subjunction — a connecting word like 'att' (that), 'om' (if), 'när' (when), 'eftersom' (because), 'fastän' (although). The most important rule in Swedish bisatser is the BIFF-regeln: sentence adverbs like 'inte', 'aldrig', 'redan', 'alltid' move to BEFORE the verb — the opposite of main clauses. In English, word order doesn't change inside subordinate clauses, so this is the #1 mistake English speakers make in Swedish.",
          examples: [
            { sv: "Jag äter inte kött.", en: "I don't eat meat.", note: "main clause: verb → inte" },
            { sv: "...att jag INTE äter kött.", en: "...that I don't eat meat.", note: "bisats: inte → verb (BIFF!)" },
            { sv: "Jag vet att han inte kommer.", en: "I know that he isn't coming.", note: "att-bisats (content clause)" },
            { sv: "Om du inte har tid, ring mig.", en: "If you don't have time, call me.", note: "om-bisats (conditional)" },
            { sv: "När hon kommer, äter vi.", en: "When she arrives, we'll eat.", note: "när-bisats (temporal)" },
            { sv: "Han stannade hemma eftersom han var sjuk.", en: "He stayed home because he was sick.", note: "eftersom-bisats (causal)" },
            { sv: "Fastän det regnade, gick vi ut.", en: "Although it rained, we went out.", note: "fastän-bisats (concessive)" },
            { sv: "Jag tror att hon alltid tränar.", en: "I think that she always trains.", note: "alltid also shifts before the verb" },
          ],
          table: {
            headers: ["Subjunction", "Type", "Example"],
            rows: [
              ["att", "content (that)", "Jag vet att han kommer."],
              ["om", "conditional (if)", "Om du inte har tid, ring mig."],
              ["när", "temporal (when)", "När hon kommer, äter vi."],
              ["medan", "temporal (while)", "Medan jag lagar mat, läser han."],
              ["eftersom", "causal (because)", "Han stannade eftersom han var sjuk."],
              ["fastän / fast", "concessive (although)", "Fastän det regnade, gick vi ut."],
              ["innan", "temporal (before)", "Innan du går, stäng dörren."],
              ["efter att", "temporal (after)", "Efter att han hade ätit, gick han."],
              ["så att", "result (so that)", "Tala långsamt så att jag förstår."],
              ["för att", "purpose (in order to)", "Han tränar för att bli stark."],
            ],
          },
          tip: "BIFF-regeln: in a bisats, the sentence adverb (inte, aldrig, redan, alltid) goes BEFORE the verb. Test: if you can put 'that/if/when/because' in front, it's a bisats — and inte moves forward. Main: 'Jag äter inte' → Bisats: '...att jag inte äter'. The subjunctions att, om, när, eftersom, fastän, medan, innan, så att, för att ALL trigger BIFF.",
        },
        exercises: [
          { q: "Which is correct bisats?\n'Jag vet att han ___.'", options: ["inte kommer", "kommer inte", "ej kommer"], correct: 0, explanation: "BIFF-regeln: in a bisats, inte goes before the verb. att han inte kommer." },
          { q: "Choose: 'Om du ___ tid, ring mig!'", options: ["har inte", "inte har", "have not"], correct: 1, explanation: "Subordinate clause after 'om': inte before verb (BIFF). Om du inte har tid..." },
          { q: "Which is correct?", options: ["Jag tror att hon alltid tränar.", "Jag tror att hon tränar alltid.", "Jag tror alltid att hon tränar."], correct: 0, explanation: "In bisats after att: adverb (alltid) before verb (BIFF): att hon alltid tränar." },
          { q: "Fill in: 'Han sa att han ___ (had never been) i Sverige.'", options: ["aldrig hade varit", "hade aldrig varit", "aldrig var"], correct: 0, explanation: "BIFF in bisats: subject + aldrig + verb: att han aldrig hade varit." },
          { q: "Which clause is correct?", options: ["...eftersom vi inte har pengar.", "...eftersom vi har inte pengar.", "...eftersom inte vi har pengar."], correct: 0, explanation: "Eftersom introduces a bisats: vi + inte + har (BIFF). vi inte har pengar." },
          { q: "Which subjunction means 'because'?", options: ["eftersom", "fastän", "innan"], correct: 0, explanation: "Eftersom = because (causal). Fastän = although. Innan = before." },
          { q: "Choose: 'Fastän det regnade, ___ vi ut.'", options: ["gick", "vi gick", "gå"], correct: 0, explanation: "Fronting a bisats triggers V2 in the main clause: Fastän det regnade + gick (verb pos.2) + vi (subject pos.3)." },
          { q: "Which means 'so that' (result)?", options: ["så att", "för att", "att"], correct: 0, explanation: "Så att = so that (result). För att = in order to (purpose). Tala långsamt så att jag förstår." },
        ],
      },
    ],
  },
